...
feature-state.json を更新: phase を "check"、check.status を "in_progress" に設定する。
...
feature-state.json を更新:
- **PASS**: check.status を "done"、phase を "done" に設定
- **NEEDS_FIX**: phase を "spec" に戻し、spec.status を "in_progress" に戻す
